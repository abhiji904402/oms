...
export const RiderLocationMapModal: React.FC<RiderLocationMapModalProps> = ({
  ...
  useEffect(() => {
    ...
    OUTLET_LOCATIONS.forEach((outlet) => {
      ...
      if (!markersRef.current[outletKey]) {
    ...
    partners.forEach((partner) => {
      ...
      if (markersRef.current[riderKey]) {
        // Update position smoothly
        markersRef.current[riderKey].setLngLat([loc.lng, loc.lat]);
      } else {
        const el = document.createElement('div');
  ...
  }, [partners, selectedPartnerId, isOpen]);
          ...
          <div className="lg:col-span-2 relative bg-[#060813] min-h-[380px] sm:min-h-[480px] p-3 sm:p-4 flex flex-col justify-between overflow-hidden">
            ...
            <div className="relative z-10 flex flex-wrap items-center justify-between gap-2 bg-[#0c0f24]/90 backdrop-blur border border-indigo-900/60 p-3 rounded-2xl shadow-xl">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-extrabold text-white">OpenFreeMap Liberty Map</span>
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-2.5 py-1 rounded-xl bg-purple-900/60 hover:bg-purple-800 border border-purple-600/50 text-purple-200 text-[11px] font-bold flex items-center gap-1 transition"
                >
                ...
                {activePartner && (
                  <a
                    ...
                    className="bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-[11px] px-2.5 py-1 rounded-xl flex items-center gap-1 transition"
                  >
            ...
            <div className="relative z-10 my-3 flex-1 border border-indigo-950 rounded-2xl overflow-hidden shadow-2xl min-h-[280px]">
