...
const APPS_SCRIPT_CODE = `// Google Apps Script for Bakery Order Live Sync (Create, Edit & Delete)
function doPost(e) {
  try {
...
function doGet(e) {
  return ContentService.createTextOutput("Bakery OMS Live Google Sheets Sync Webhook is Active!");
}`;
